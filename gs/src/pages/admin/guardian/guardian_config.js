        ...
        <aside className="sidebar-wrapper" data-simplebar="true">
          ...
          <ul className="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> <Link to="widgets-static-widgets.html"><i className="bi bi-circle"></i>View Students</Link>
                </li>
            ...
            <li>
              ...
              <ul>
                <li> <Link to="widgets-static-widgets.html"><i className="bi bi-circle"></i>View Teacher</Link>
                </li>
              </ul>
            </li>
            {/** End of Teacher */}
          ...
          {/** Registrar */}
            <li>
              <ul>
                <li> <Link to="widgets-static-widgets.html"><i className="bi bi-circle"></i>View Registrar</Link>
                </li>
              </ul>
            </li>
            {/** End of Registrar */}
            ...
            <li>
              <ul>
                <li> <Link to="widgets-static-widgets.html"><i className="bi bi-circle"></i>View Dean</Link>
                </li>
              </ul>
            </li>
            {/** End of Dean */}
            ...
            <li>
              <ul>
                <li> <Link to="widgets-static-widgets.html"><i className="bi bi-circle"></i>View Guardian</Link>
                </li>
              </ul>
            </li>
            {/** End of Guardiab */}
            ...
            <li>
              <ul>
                <li> <Link to="widgets-static-widgets.html"><i className="bi bi-circle"></i>Admin Account</Link>
                </li>
              </ul>
            </li>
            {/** End of Account */}
...
<ul>
  <li> <Link to="widgets-static-widgets.html"><i className="bi bi-circle"></i>Add Department</Link>
  </li>
</ul>
</li>
{/**End of Department  */}
...
<li>
              <ul>
                <li> <Link to="widgets-static-widgets.html"><i className="bi bi-circle"></i>Add Year And Course</Link>
                </li>
              </ul>
            </li>
      ...
      {/**End of course  */}
          ...
          {/** Add Subject */}
                   <li>
              <ul>
                <li> <Link to="widgets-static-widgets.html"><i className="bi bi-circle"></i>Add Subject</Link>
                </li>
              </ul>
            </li>
            {/** End of Subject */}
          ...
          {/** Add Section */}
            <li>
              <ul>
                <li> <Link to="widgets-static-widgets.html"><i className="bi bi-circle"></i>Add Section</Link>
                </li>
              </ul>
            </li>
            {/** End of Section */}
